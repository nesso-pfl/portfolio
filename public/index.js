...
})(PS["Plugin.Firebase"] = PS["Plugin.Firebase"] || {});
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  "use strict";
  $PS["Plugin.Firebase"] = $PS["Plugin.Firebase"] || {};
  var exports = $PS["Plugin.Firebase"];
  var $foreign = $PS["Plugin.Firebase"];
  var Effect_Uncurried = $PS["Effect.Uncurried"];                                           
  var initializeApp = Effect_Uncurried.runEffectFn2($foreign.initializeApp_);
  var firestore = Effect_Uncurried.runEffectFn1($foreign.firestore_);
  var firebaseConfig = {
  ...
  var collection = Effect_Uncurried.runEffectFn2($foreign.collection_);
  var add = Effect_Uncurried.runEffectFn2($foreign.add_);
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["API.Blogs"] = $PS["API.Blogs"] || {};
  var exports = $PS["API.Blogs"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect = $PS["Effect"];
  var Plugin_Firebase = $PS["Plugin.Firebase"];                
  var createBlog = function (blogOpt) {
      return function __do() {
          var v = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Plugin_Firebase.initializeApp(Plugin_Firebase.firebaseConfig)(Data_Maybe.Nothing.value))(Plugin_Firebase.firestore))(Plugin_Firebase.collection("blogs"))();
          return Plugin_Firebase.add(blogOpt)(v)();
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Plugin.HalogenR"] = $PS["Plugin.HalogenR"] || {};
  var exports = $PS["Plugin.HalogenR"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Events = $PS["Halogen.HTML.Events"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var divCI1 = function (cls) {
      return function (i) {
          return function (e) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(cls), Halogen_HTML_Properties.id_(i) ])([ e ]);
          };
      };
  };
  var divCE1 = function (cls) {
      return function (action) {
          return function (e) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(cls), Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(action);
              }) ])([ e ]);
          };
      };
  };
  var divC1 = function (cls) {
      return function (e) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(cls) ])([ e ]);
      };
  };
  var divC = function (cls) {
      return function (es) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(cls) ])(es);
      };
  };
  var buttonCE1 = function (cls) {
      return function (action) {
          return function (e) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(cls), Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(action);
              }) ])([ e ]);
          };
      };
  ...
  exports["divC"] = divC;
  exports["divC1"] = divC1;
  exports["divCE1"] = divCE1;
  exports["divCI1"] = divCI1;
  exports["buttonCE1"] = buttonCE1;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Component.Header"] = $PS["Component.Header"] || {};
  var exports = $PS["Component.Header"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Plugin_HalogenR = $PS["Plugin.HalogenR"];                
  var Goto = (function () {
  ...
  var handleAction = function (v) {
      ...
      return Halogen_Query_HalogenM.raise("/" + Data_String_Common.toLower(v.value0));
  };
  var contents = [ "Home", "Blog", "Knowledge", "Biography", "Products", "Budo" ];
  var render = function (v) {
      var headerContents = Data_Functor.map(Data_Functor.functorArray)(function (c) {
          return Plugin_HalogenR.divCE1("content " + Data_String_Common.toLower(c))(new Goto(c))(Halogen_HTML_Core.text(c));
      })(contents);
      return Halogen_HTML_Elements.header([ Halogen_HTML_Properties.class_("header") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(headerContents)([ Halogen_HTML_Elements.link([ Halogen_HTML_Properties.href("/assets/sass/header.sass") ]) ]));
  };
  var ui = Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var textParser = Data_Functor.map(Text_Parsing_StringParser.functorParser)(function ($74) {
      return HtmlText.create($foreign.decodeHtmlEntity($74));
  ...
  var charListToString = (function () {
      ...
      return function ($76) {
          return Data_String_CodeUnits.fromCharArray($75($76));
      };
  })();
  var commentParser = Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.skipSpaces)(function () {
      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_CodeUnits.string("<!--"))(Text_Parsing_StringParser_Combinators.manyTill(Text_Parsing_StringParser_CodeUnits.anyChar)(Text_Parsing_StringParser_CodeUnits.string("-->"))))(function (v) {
          return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(HtmlComment.create(charListToString(v)));
      });
  });
  var attributeParser = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.regex("[^=>/]+"))(function (v) {
      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.option("")(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(equals)(quotedString)))(function (v1) {
          return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(new HtmlAttribute(v, v1));
      });
  });
  var openingParser = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.string("<"))(function (v) {
      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.regex("[^/>\x0a ]+"))(function (v1) {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_CodeUnits.whiteSpace)(Text_Parsing_StringParser_Combinators.sepEndBy(attributeParser)(Text_Parsing_StringParser_CodeUnits.whiteSpace)))(function (v2) {
              return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(mkElement(v1)(v2)(Data_List_Types.Nil.value));
          });
      });
  });
  ...
  var elementParser = Control_Lazy.defer(Text_Parsing_StringParser.lazyParser)(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_CodeUnits.skipSpaces)(function () {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Bind.bind(Text_Parsing_StringParser.bindParser)(openingParser)(closingOrChildrenParser))((function () {
              var $77 = Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser);
              return function ($78) {
                  return $77(HtmlElement.create($78));
              };
          })());
      });
  });
  var closingOrChildrenParser = function (element) {
      var childrenParser = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_CodeUnits.whiteSpace)(Text_Parsing_StringParser_CodeUnits.string(">")))(function (v) {
          return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.manyTill(nodeParser)(Text_Parsing_StringParser_CodeUnits.string("</" + (element.name + ">"))))(function (v1) {
      ...
      return Control_Lazy.defer(Text_Parsing_StringParser.lazyParser)(function (v) {
          var $73 = isSelfClosingElement(element);
          if ($73) {
...
(function($PS) {
  ...
  var render_ = render([  ]);
  exports["htmlAttributeToProp"] = htmlAttributeToProp;
  exports["elementToHtml"] = elementToHtml;
  exports["nodeToHtml"] = nodeToHtml;
  exports["parse"] = parse;
  exports["render_"] = render_;
  exports["render"] = render;
  exports["renderToArray"] = renderToArray;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Biography"] = $PS["Page.Biography"] || {};
  var exports = $PS["Page.Biography"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  ...
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Biography") ]) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Blog"] = $PS["Page.Blog"] || {};
  var exports = $PS["Page.Blog"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Show = $PS["Data.Show"];
  var Halogen_Component = $PS["Halogen.Component"];
  ...
  var Plugin_HalogenR = $PS["Plugin.HalogenR"];                
  var render = function (st) {
      var blogMain = Data_Functor.map(Data_Functor.functorArray)(function (b) {
          return Plugin_HalogenR.divC("blog")([ Plugin_HalogenR.divC1("header")(Plugin_HalogenR.divC1("title")(Halogen_HTML_Core.text(b.title))), Plugin_HalogenR.divC1("main")(Plugin_HalogenR.divC1("text")(Halogen_HTML_Core.text(b.text))), Plugin_HalogenR.divC("footer")([ Plugin_HalogenR.divC("tags")(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.text)(b.tags)), Plugin_HalogenR.divC1("date")(Halogen_HTML_Core.text(b.date)), Plugin_HalogenR.divC1("comments")(Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Data_Array.length(b.comments)))) ]) ]);
      });
      return Plugin_HalogenR.divC("page blog")([ Plugin_HalogenR.divC1("left-area")(Halogen_HTML_Core.text("Recent Act and Search Form")), Plugin_HalogenR.divC("central-area")(blogMain(st)), Plugin_HalogenR.divC1("right-area")(Halogen_HTML_Core.text("Adds")) ]);
  };
...
})(PS["Plugin.MarkdownIt"] = PS["Plugin.MarkdownIt"] || {});
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Plugin.MarkdownIt"] = $PS["Plugin.MarkdownIt"] || {};
  var exports = $PS["Plugin.MarkdownIt"];
  var $foreign = $PS["Plugin.MarkdownIt"];
  ...
  var showPreset = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Plugin.MarkdownIt (line 40, column 10 - line 43, column 19): " + [ v.constructor.name ]);
  });                                                                      
  ...
  var linkify = Data_Options.opt("linkify");      
  var html = Data_Options.opt("html");
  exports["CommonMark"] = CommonMark;
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Plugin.Vim"] = $PS["Plugin.Vim"] || {};
  var exports = $PS["Plugin.Vim"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var justThen = function (f) {
      return function (a) {
          var $9 = Data_Maybe.isJust(a);
          if ($9) {
              return f(Data_Maybe.fromJust()(a));
          };
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
      };
  };
  var withVimDom = function (f) {
      return function __do() {
          var v = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))((function () {
              var $20 = Web_DOM_NonElementParentNode.getElementById("editor-vim");
              return function ($21) {
                  return $20(Web_HTML_HTMLDocument.toNonElementParentNode($21));
              };
          })())();
          var el = Control_Bind.bind(Data_Maybe.bindMaybe)(v)(Web_HTML_HTMLElement.fromElement);
          return justThen(f)(el)();
      };
  };
  var keyEvent_ = function (e) {
      if (Web_UIEvent_KeyboardEvent.ctrlKey(e)) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
      };
      if (Web_UIEvent_KeyboardEvent.shiftKey(e)) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
      };
      if (Data_Boolean.otherwise) {
          var v = Web_UIEvent_KeyboardEvent.key(e);
          if (v === "i") {
              return function __do() {
                  Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(e))();
                  return withVimDom(Web_HTML_HTMLElement.focus)();
              };
          };
          if (v === "Escape") {
              return withVimDom(Web_HTML_HTMLElement.blur);
          };
          return function __do() {
              Effect_Console.log(Web_UIEvent_KeyboardEvent.key(e))();
              return Data_Unit.unit;
          };
      };
      throw new Error("Failed pattern match at Plugin.Vim (line 39, column 1 - line 39, column 42): " + [ e.constructor.name ]);
  };
  var keyEvent = function (e) {
      return justThen(keyEvent_)(Web_UIEvent_KeyboardEvent.fromEvent(e));
  };                                                                                                                                                                                 
  var addKeydownEvent = function __do() {
      var v = (function __do() {
          var $22 = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document)();
          return Web_DOM_Document.documentElement(Web_HTML_HTMLDocument.toDocument($22))();
      })();
      return justThen(function (e) {
          return function __do() {
              var v1 = Web_Event_EventTarget.eventListener(keyEvent)();
              return Halogen_VDom_Util.addEventListener("keydown", v1, e);
          };
      })(v)();
  };
  exports["addKeydownEvent"] = addKeydownEvent;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Blog.Edit"] = $PS["Page.Blog.Edit"] || {};
  var exports = $PS["Page.Blog.Edit"];
  var API_Blogs = $PS["API.Blogs"];
  var Ace = $PS["Ace"];
  ...
  var Plugin_HalogenR = $PS["Plugin.HalogenR"];
  var Plugin_MarkdownIt = $PS["Plugin.MarkdownIt"];
  var Plugin_Vim = $PS["Plugin.Vim"];                
  ...
  var InputText = (function () {
      function InputText(value0) {
          this.value0 = value0;
      };
      InputText.create = function (value0) {
          return new InputText(value0);
      };
      return InputText;
  })();
  ...
  var AddKeyEvent = (function () {
      ...
      AddKeyEvent.value = new AddKeyEvent();
      return AddKeyEvent;
  })();
  var render = function (st) {
      return Plugin_HalogenR.divC("page blog-edit")([ Plugin_HalogenR.divC1("title")(Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function ($41) {
          return Data_Maybe.Just.create(ChangeTitle.create($41));
      }) ])), Plugin_HalogenR.divC("edit-area")([ Plugin_HalogenR.divCI1("input")("editor-ace")(Halogen_HTML_Core.text("")), Plugin_HalogenR.divC1("rendered")(Html_Renderer_Halogen.render_(st.renderedText)) ]), Plugin_HalogenR.buttonCE1("btn-save")(SaveBlog.value)(Halogen_HTML_Core.text("\u4fdd\u5b58")) ]);
  };
  var initialState = function (v) {
      return {
          blog: {
  ...
  var handleAction = function (v) {
      if (v instanceof ChangeTitle) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              ...
              $18.blog = (function () {
                  var $15 = {};
                  for (var $16 in v2.blog) {
                      if ({}.hasOwnProperty.call(v2.blog, $16)) {
                          $15[$16] = v2["blog"][$16];
                      };
                  };
                  $15.title = v.value0;
      ...
      if (v instanceof InputText) {
          var opt = Data_Semigroup.append(Data_Options.semigroupOptions)(Data_Options.assoc(Plugin_MarkdownIt.html)(true))(Data_Options.assoc(Plugin_MarkdownIt.linkify)(true));
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Plugin_MarkdownIt.newMarkdownIt(Plugin_MarkdownIt.CommonMark.value)(opt)))(function (v2) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Plugin_MarkdownIt.render(v2)(v.value0)))(function (v3) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                      ...
                      $27.blog = (function () {
                          var $24 = {};
                          for (var $25 in v4.blog) {
                              if ({}.hasOwnProperty.call(v4.blog, $25)) {
                                  $24[$25] = v4["blog"][$25];
                              };
                          };
                          $24.text = v.value0;
      ...
      if (v instanceof SaveBlog) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(Data_DateTime.showDateTime)(Data_DateTime_Instant.toDateTime(v1)))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $35.blog = (function () {
                          var $32 = {};
                          for (var $33 in v2.blog) {
                              if ({}.hasOwnProperty.call(v2.blog, $33)) {
                                  $32[$33] = v2["blog"][$33];
                              };
                          };
                          $32.date = Data_Show.show(Data_Time_Duration.showMilliseconds)(Data_DateTime_Instant.unInstant(v1));
                          return $32;
                      })();
                      return $35;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(API_Blogs.createBlog(v2)))(function (v3) {
                              return Halogen_Query_HalogenM.raise("/blog");
                          });
                      });
                  });
              });
      ...
      if (v instanceof InitAce) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Ace.edit("editor-ace")(Ace.ace)))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Ace_Editor.getSession(v1))(Ace_EditSession.getDocument)))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          });
      };
      if (v instanceof AddKeyEvent) {
          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Plugin_Vim.addKeydownEvent);
      };
      throw new Error("Failed pattern match at Page.Blog.Edit (line 80, column 16 - line 111, column 35): " + [ v.constructor.name ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
      "eval": Halogen_Component.mkEval({
          ...
          handleQuery: Halogen_Component.defaultEval.handleQuery,
          receive: Halogen_Component.defaultEval.receive,
          initialize: new Data_Maybe.Just(InitAce.value),
          finalize: Halogen_Component.defaultEval.finalize
      })
  });
  exports["ui"] = ui;
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Budo"] = $PS["Page.Budo"] || {};
  var exports = $PS["Page.Budo"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Budo") ]) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(Data_Show.show(Data_Unit.showUnit)(st)) ]) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Knowledge"] = $PS["Page.Knowledge"] || {};
  var exports = $PS["Page.Knowledge"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Knowledge") ]) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Page.Products"] = $PS["Page.Products"] || {};
  var exports = $PS["Page.Products"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Products") ]) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: render,
...
(function($PS) {
  ...
  var Component_Header = $PS["Component.Header"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Page_Biography = $PS["Page.Biography"];
  var Page_Blog = $PS["Page.Blog"];
  var Page_Blog_Edit = $PS["Page.Blog.Edit"];
  var Page_Budo = $PS["Page.Budo"];
  var Page_Home = $PS["Page.Home"];
  var Page_Knowledge = $PS["Page.Knowledge"];
  var Page_Products = $PS["Page.Products"];
  ...
  var ListenRoute = (function () {
      function ListenRoute(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ListenRoute.create = function (value0) {
          return function (value1) {
              return new ListenRoute(value0, value1);
          };
      };
      return ListenRoute;
  })();
  var ChangeRoute = (function () {
      function ChangeRoute(value0) {
          this.value0 = value0;
      };
      ChangeRoute.create = function (value0) {
          return new ChangeRoute(value0);
      };
      return ChangeRoute;
  })();
  var routing = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Blog.value)(Routing_Match.root))(Routing_Match.lit("blog")))(Routing_Match.end))(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(BlogE.value)(Routing_Match.root))(Routing_Match.lit("blog")))(Routing_Match.lit("edit"))))(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Biography.value)(Routing_Match.root))(Routing_Match.lit("biography")))(Routing_Match.end)))(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Budo.value)(Routing_Match.root))(Routing_Match.lit("budo")))(Routing_Match.end)))(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Products.value)(Routing_Match.root))(Routing_Match.lit("products")))(Routing_Match.end)))(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Knowledge.value)(Routing_Match.root))(Routing_Match.lit("knowledge")))(Routing_Match.end)))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Home.value)(Routing_Match.root));
  var listenRoute = function (io) {
      return function (v) {
          return function (newRoute) {
              return function __do() {
                  var v1 = Effect_Aff.launchAff(io.query(Halogen_Query.tell(ListenRoute.create(newRoute))))();
                  return Data_Unit.unit;
              };
          };
      };
  ...
  var _products = Data_Symbol.SProxy.value;
  var _knowledge = Data_Symbol.SProxy.value;
  var _home = Data_Symbol.SProxy.value;
  var _header = Data_Symbol.SProxy.value;
  var _budo = Data_Symbol.SProxy.value;
  var _blogE = Data_Symbol.SProxy.value;
  var _blog = Data_Symbol.SProxy.value;
  var _biography = Data_Symbol.SProxy.value;
  var render = function (st) {
      var view = function (v) {
          if (v instanceof Home) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "home";
              }))(Data_Ord.ordUnit)(_home)(Data_Unit.unit)(Page_Home.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof Blog) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "blog";
              }))(Data_Ord.ordUnit)(_blog)(Data_Unit.unit)(Page_Blog.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof BlogE) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "blogE";
              }))(Data_Ord.ordUnit)(_blogE)(Data_Unit.unit)(Page_Blog_Edit.ui)(Data_Unit.unit)(function ($19) {
                  return Data_Maybe.Just.create(ChangeRoute.create($19));
              });
          };
          if (v instanceof Biography) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "biography";
              }))(Data_Ord.ordUnit)(_biography)(Data_Unit.unit)(Page_Biography.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof Budo) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "budo";
              }))(Data_Ord.ordUnit)(_budo)(Data_Unit.unit)(Page_Budo.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof Knowledge) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "knowledge";
              }))(Data_Ord.ordUnit)(_knowledge)(Data_Unit.unit)(Page_Knowledge.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof Products) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "products";
              }))(Data_Ord.ordUnit)(_products)(Data_Unit.unit)(Page_Products.ui)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Router (line 106, column 9 - line 106, column 58): " + [ v.constructor.name ]);
      };
      return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "header";
      }))(Data_Ord.ordUnit)(_header)(Data_Unit.unit)(Component_Header.ui)(Data_Unit.unit)(function ($20) {
          return Data_Maybe.Just.create(ChangeRoute.create($20));
      }), view(st.currentPage) ]);
  };
  var ui = Halogen_Component.mkComponent({
      initialState: initialState,
  ...
  exports["_home"] = _home;
  exports["_blog"] = _blog;
  exports["_blogE"] = _blogE;
  exports["_biography"] = _biography;
  exports["_budo"] = _budo;
  exports["_knowledge"] = _knowledge;
  exports["_products"] = _products;
  exports["initialState"] = initialState;
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_PushState.makeInterface))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Router.ui)(Data_Unit.unit)(v))(function (v2) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_PushState.matches(Router.routing)(Router.listenRoute(v2))(v1)))(function (v3) {
                  return v2.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (url) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                          v1.pushState(Foreign.unsafeToForeign({}))(url)();
                          return Data_Maybe.Nothing.value;
                      });
                  }));
              });
