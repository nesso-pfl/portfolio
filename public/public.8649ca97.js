...
(function ($PS) {
  ...
  $PS["Biography"] = $PS["Biography"] || {};
  var exports = $PS["Biography"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
...
(function ($PS) {
  ...
  var render = function render(v) {
    return Halogen_HTML_Elements.div_([Halogen_HTML_Elements.h1_([Halogen_HTML_Core.text("Blog")])]);
  };
...
(function ($PS) {
  ...
  var render = function render(v) {
    var headerContents = Data_Functor.map(Data_Functor.functorArray)(function (c) {
      return Halogen_HTML_Elements.div([Halogen_HTML_Properties.classes(["content", Halogen_HTML_Core.ClassName(Data_String_Common.toLower(c))]), Halogen_HTML_Events.onClick(function (v1) {
        return Data_Maybe.Just.create(new Goto(c));
      })])([Halogen_HTML_Core.text(c)]);
    })(contents);
...
(function ($PS) {
  ...
  $PS["Knowledge"] = $PS["Knowledge"] || {};
  var exports = $PS["Knowledge"];
  var Data_Function = $PS["Data.Function"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
...
(function ($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Header = $PS["Header"];
  var Home_1 = $PS["Home"];
  var Knowledge_1 = $PS["Knowledge"];
  var Products_1 = $PS["Products"];
  ...
  var routing = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Blog.value)(Routing_Match.lit("")))(Routing_Match.lit("blog")))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Biography.value)(Routing_Match.lit("")))(Routing_Match.lit("biography"))))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Budo.value)(Routing_Match.lit("")))(Routing_Match.lit("budo"))))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Products.value)(Routing_Match.lit("")))(Routing_Match.lit("products"))))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Knowledge.value)(Routing_Match.lit("")))(Routing_Match.lit("knowledge"))))(Data_Functor.voidRight(Routing_Match.matchFunctor)(Home.value)(Routing_Match.lit("")));

  var listenRoute = function listenRoute(io) {
    return function (v) {
  ...
  var render = function render(st) {
    var view = function view(v) {
      if (v instanceof Home) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "home";
        }))(Data_Ord.ordUnit)(_home)(Data_Unit.unit)(Home_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }
      ...
      if (v instanceof Blog) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "blog";
        }))(Data_Ord.ordUnit)(_blog)(Data_Unit.unit)(Blog_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }
      ...
      if (v instanceof Biography) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "biography";
        }))(Data_Ord.ordUnit)(_biography)(Data_Unit.unit)(Biography_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }
      ...
      if (v instanceof Budo) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "budo";
        }))(Data_Ord.ordUnit)(_budo)(Data_Unit.unit)(Budo_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }
      ...
      if (v instanceof Knowledge) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "knowledge";
        }))(Data_Ord.ordUnit)(_knowledge)(Data_Unit.unit)(Knowledge_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }
      ...
      if (v instanceof Products) {
        return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
          return "products";
        }))(Data_Ord.ordUnit)(_products)(Data_Unit.unit)(Products_1.ui)(Data_Unit.unit)(Data_Void.absurd);
      }

      ;
      throw new Error("Failed pattern match at Router (line 104, column 9 - line 104, column 58): " + [v.constructor.name]);
    };

    return Halogen_HTML_Elements.div_([Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
      return "header";
    }))(Data_Ord.ordUnit)(_header)(Data_Unit.unit)(Header.ui)(Data_Unit.unit)(function (msg) {
      return Data_Maybe.Just.create(new ChangeRoute(msg));
    }), view(st.currentPage)]);
  };
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/index.js"], null)
